...
const dict = {
  ...
  zh: {
    ...
    ship_stage_ordered: '已下单',
    ship_stage_preparing: '卖家备货中',
    ship_stage_shipping: '运输中',
    ship_stage_delivered: '已送达',

    bank_accounts_title: '银行账户',
    bank_accounts_empty: '您还没有绑定银行账户。添加账户以加快提现速度。',
    bank_accounts_add: '添加银行账户',
    bank_field_bank_name: '银行名称',
    bank_field_account_number: '账号',
    bank_field_account_holder: '账户持有人',
    bank_accounts_note: '示例（模拟）数据 — 尚未连接真实银行验证接口。',
    bank_accounts_save: '保存账户',
    wallet_history_title: '钱包交易记录',

    settings_password_title: '修改密码',
    settings_password_desc: '修改您账户的登录密码。',
    settings_password_current: '当前密码',
    settings_password_new: '新密码',
    settings_password_note: '您当前使用 Google 登录，暂不需要密码 — 此功能将在后续开启邮箱/密码登录后启用。',

    modal_timeline_title: '状态时间线',
    modal_timeline_recorded: '订单已记录',
    modal_buy_again: '再次购买',

    wd_notice_title: '创建提现申请',
    wd_notice_desc: '将资金提现到您的银行账户或电子钱包。达到 {min} 即可提现。',
    wd_create_title: '创建提现',
    wd_create_min: '最低 {min} · 无上限',
    wd_amount_label: '提现金额',
    wd_amount_placeholder: '输入金额',
    wd_min_error: '最低提现金额为 {min}。',
    wd_submit_btn: '立即提现',
    wd_filter_all: '全部',
    wd_filter_pending: '待审核',
    wd_filter_done: '已完成',
    wd_filter_cancelled: '已取消',
    wd_count_label: '笔',
    wd_view_detail: '详情',
    wd_detail_title: '提现详情',
    wd_created_at: '创建时间',
    wd_updated_at: '更新时间',
    wd_code_label: '交易编号',
    wd_support_note: '联系客服时请提供此交易编号 — 便于管理员更快查询您的请求。',
    wd_status_done: '已完成',
    wd_status_pending: '待审核',
    wd_status_cancelled: '已取消',
